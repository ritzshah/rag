...
try:
    ...
    def query_similar_documents(query_text, top_k=5):
        ...
        for result in results:
            ...
            similarity_scores.append((similarity_score, result.metadata.get("source", "Source URL not found")))
    ...
    query_text = "Red Hat OpenShift AI content"
    similar_docs = query_similar_documents(query_text)

    # Print the top results
    for score, source in similar_docs:
